...
This includes removing the Sphinx build directory (docs/_build), all __pycache__ directories, 
and all .pyc files. This helps ensure that the project is in a clean state before building 
documentation or running tests, and prevents issues caused by stale build artifacts or cache 
files.
"""
# Metadata
