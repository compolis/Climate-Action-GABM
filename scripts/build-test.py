#!/usr/bin/env python3
"""
Platform-agnostic build and test install script for Climate-Action-GABM.
- Builds the package (wheel and sdist)
- Creates a fresh virtual environment
- Installs the built wheel
- Imports gabm to verify install
- (Optional) Runs 'python -m cag --help' to check entry point
"""
# Metadata
...
# Try importing cag
print("Verifying import of cag...")
subprocess.check_call([str(venv_python), "-c", "import cag; print('cag import OK')"])

# Optionally, check CLI entry point
try:
    print("Checking 'python -m cag --help'...")
    subprocess.check_call([str(venv_python), "-m", "cag", "--help"])
except Exception as e:
    print("Warning: 'python -m cag --help' failed:", e)
