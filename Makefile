...
.PHONY: help test docs docs-clean gh-pages-deploy clean git-clean clear-caches sync sync-feature release delete-release build build-test pypi-release testpypi-release bump-version
